Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "home_direct_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: AppConfig['site']['hostname'], port: AppConfig['site']['port'],
    protocol: AppConfig['site']['protocol'] }
