...
App.listing["publish"] = function(){
  $("#btn_publish_listing").click(function(e){
    // e.preventDefault();
    // alert('... publish');
  });
}
...
for (var property in App.listing) {
    if (App.listing.hasOwnProperty(property)) {
        // $(document).on("turbolinks:load", App.listing[property]);
        $(document).ready(App.listing[property]);
    }
}
